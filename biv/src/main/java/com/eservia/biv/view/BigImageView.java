...
import com.eservia.biv.R;
import com.eservia.biv.indicator.ProgressIndicator;
import com.eservia.biv.loader.ImageLoader;
import com.eservia.biv.metadata.ImageInfoExtractor;
import com.eservia.biv.utils.DisplayOptimizeListener;
import com.eservia.biv.utils.IOUtils;
import com.eservia.biv.utils.ThreadedCallbacks;
import com.eservia.subscaleview.SubsamplingScaleImageView;
...
public class BigImageView extends FrameLayout implements ImageLoader.Callback {
    ...
    public BigImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (isInEditMode()) {
            ...
            mImageLoader = (ImageLoader) BigImageViewer.imageLoader();
        }
    ...
    public void setOptimizeDisplay(boolean optimizeDisplay) {
        ...
        if (mOptimizeDisplay) {
            ...
            mSSIV.setOnImageEventListener((SubsamplingScaleImageView.OnImageEventListener) mDisplayOptimizeListener);
        } else {
