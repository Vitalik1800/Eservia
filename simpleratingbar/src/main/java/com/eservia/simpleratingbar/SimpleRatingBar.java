package com.eservia.simpleratingbar;
...
public class SimpleRatingBar extends View {
  ...
  public SimpleRatingBar(Context context, OnRatingBarChangeListener ratingListener) {
    super(context);
  ...
  private void initView() {
    starPath = new Path();
    CornerPathEffect cornerPathEffect = new CornerPathEffect(starCornerRadius);
  ...
  private void parseAttrs(AttributeSet attrs) {
    ...
    starsSeparation = arr.getDimensionPixelSize(R.styleable.SimpleRatingBar_srb_starsSeparation, (int)valueToPixels());
  ...
  private float valueToPixels() {
    return applyDimension(COMPLEX_UNIT_DIP, (float) 4, getResources().getDisplayMetrics());
  }
  ...
  public static class AnimationBuilder {
    ...
    private AnimationBuilder(SimpleRatingBar ratingBar, AnimatorListener animatorListener) {
