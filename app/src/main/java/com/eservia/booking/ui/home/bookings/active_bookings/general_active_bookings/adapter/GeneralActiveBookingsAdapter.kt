...
class GeneralActiveBookingsAdapter(private val paginationListener: BookingPaginationListener,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            BookingKindEnum.BEAUTY -> {
                val itemView = inflater.inflate(R.layout.item_booking_beauty, parent, false)
