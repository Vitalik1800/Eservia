...
public class BookingErrorDialog extends BaseDialogFragment {
    ...
    public static BookingErrorDialog newInstance() {
        BookingErrorDialog f = new BookingErrorDialog();
    ...
    private void initViews() {
        tvDialogLabel.setText(getContext().getResources().getString(R.string.activity_reservation_reservation_error_title));
        tvDialogMessage.setText(getContext().getResources().getString(R.string.activity_reservation_reservation_error_content));
