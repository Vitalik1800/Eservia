...
public class NewsAdapter extends BaseRecyclerAdapter<Marketing> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_business_page_beauty_info_news, parent, false);
        ...
        if (type != null) {
            ...
            if (type.equals(Marketing.TYPE_NEWS)) {
                ...
                if (discount != null && discountType != null && discountType.equals(Marketing.DISCOUNT_PERCENT)) {
                    holder.rlMark.setVisibility(View.VISIBLE);
                    holder.ivMark.setBackground(ContextCompat.getDrawable(mContext, R.drawable.background_sale));
                    holder.tvMark.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                            mContext.getResources().getDimension(R.dimen.mark_promo_text_size));
                    holder.tvMark.setText(mContext.getResources().getString(R.string.sale_mark, marketing.getDiscount().intValue()));
                } else {
                    holder.rlMark.setVisibility(View.GONE);
                }
