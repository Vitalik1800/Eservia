...
public class CountDrawable extends Drawable {
    ...
    public CountDrawable(Context context) {
        ...
        mBadgePaint.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.red));
    ...
    public void draw(Canvas canvas) {
        ...
        if (mCount.length() <= 2) {
            // Draw badge circle.
            canvas.drawCircle(centerX, centerY, (int) (radius + 5.0), mBadgePaint);
        } else {
    ...
    public void setCount(String count) {
        ...
        mWillDraw = !count.equalsIgnoreCase("0") && !count.isEmpty();
        invalidateSelf();
    }
