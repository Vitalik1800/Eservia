...
import static com.eservia.glide.compiler.ProcessorUtil.nonNulls;

import com.eservia.glide.annotation.GlideOption;
import com.eservia.glide.annotation.GlideType;
...
final class GlideExtensionValidator {
  ...
  private static boolean isBaseRequestOptions(TypeMirror typeMirror) {
    return typeMirror.toString().equals("com.eservia.glide.request.BaseRequestOptions<?>");
  }
  ...
  private boolean isRequestBuilder(TypeMirror typeMirror) {
    ...
    return toCompare.toString().equals("com.eservia.glide.RequestBuilder");
  }
  ...
  private static void validateGlideTypeParameters(ExecutableElement executableElement) {
    ...
    if (!argumentType.toString().startsWith("com.eservia.glide.RequestBuilder")) {
      throw new IllegalArgumentException(
          "@GlideType methods must take a"
