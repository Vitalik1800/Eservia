...
public class SupportRequestManagerFragment extends Fragment {
   ...
   */
  void setParentFragmentHint(@Nullable Fragment parentFragmentHint) throws ClassNotFoundException {
  ...
  private void registerFragmentWithRoot(
      @NonNull Context context, @NonNull FragmentManager fragmentManager) throws ClassNotFoundException {
