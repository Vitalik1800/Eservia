...
import com.eservia.glide.GlideBuilder.WaitForFramesAfterTrimMemory;
import com.eservia.glide.GlideExperiments;
import com.eservia.glide.RequestManager;
import com.eservia.glide.load.resource.bitmap.HardwareConfigState;
...
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting static final String FRAGMENT_TAG = "com.eservia.glide.manager";
  ...
  @NonNull
  private RequestManager getApplicationManager(@NonNull Context context) throws ClassNotFoundException {
  ...
  @NonNull
  public RequestManager get(@NonNull Context context) throws ClassNotFoundException {
    if (context == null) {
  ...
  @NonNull
  public RequestManager get(@NonNull FragmentActivity activity) throws ClassNotFoundException {
  ...
  @NonNull
  public RequestManager get(@NonNull Fragment fragment) throws ClassNotFoundException {
  ...
  @SuppressWarnings("deprecation")
  @NonNull
  public RequestManager get(@NonNull Activity activity) throws ClassNotFoundException {
    if (Util.isOnBackgroundThread()) {
      return get(activity.getApplicationContext());
  ...
  @SuppressWarnings("deprecation")
  @NonNull
  public RequestManager get(@NonNull View view) throws ClassNotFoundException {
    if (Util.isOnBackgroundThread()) {
  ...
  @NonNull
  @TargetApi(VERSION_CODES.JELLY_BEAN_MR1)
  public RequestManager get(@NonNull android.app.Fragment fragment) throws ClassNotFoundException {
    if (fragment.getActivity() == null) {
  ...
  @Deprecated
  @NonNull
  RequestManagerFragment getRequestManagerFragment(Activity activity) throws ClassNotFoundException {
  ...
  private RequestManagerFragment getRequestManagerFragment(
      @NonNull final android.app.FragmentManager fm, @Nullable android.app.Fragment parentHint) throws ClassNotFoundException {
  ...
  private RequestManager fragmentGet(
      ...
      boolean isParentVisible) throws ClassNotFoundException {
  ...
  @NonNull
  SupportRequestManagerFragment getSupportRequestManagerFragment(FragmentManager fragmentManager) throws ClassNotFoundException {
  ...
  private SupportRequestManagerFragment getSupportRequestManagerFragment(
      @NonNull final FragmentManager fm, @Nullable Fragment parentHint) throws ClassNotFoundException {
    // If we have a pending Fragment, we need to continue to use the pending Fragment. Otherwise
    // there's a race where an old Fragment could be added and retrieved here before our logic to
    // add our pending Fragment notices. That can then result in both the pending Fragmeng and the
    // old Fragment having requests running for them, which is impossible to safely unwind.
