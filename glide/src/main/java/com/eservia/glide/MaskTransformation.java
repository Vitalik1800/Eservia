...
import com.eservia.glide.load.resource.bitmap.BitmapTransformation;
...
public class MaskTransformation extends BitmapTransformation {
  ...
  private static final String ID =
    "com.eservia.glide.MaskTransformation." + VERSION;
  ...
  @Override
  public Bitmap transform(@NonNull Context context, @NonNull BitmapPool pool,
