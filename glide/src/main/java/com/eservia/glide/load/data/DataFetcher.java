...
public interface DataFetcher<T> {
  ...
  interface DataCallback<T> {
     ...
     */
    void onDataReady(@Nullable T data) throws ClassNotFoundException;
     ...
     */
    void onLoadFailed(@NonNull Exception e) throws ClassNotFoundException;
  }
   ...
   */
  void loadData(@NonNull Priority priority, @NonNull DataCallback<? super T> callback) throws ClassNotFoundException;
