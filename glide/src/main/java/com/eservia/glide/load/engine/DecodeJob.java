...
import com.eservia.glide.GlideContext;
...
import com.eservia.glide.util.pool.FactoryPools.Poolable;
import com.eservia.glide.util.pool.GlideTrace;
import com.eservia.glide.util.pool.StateVerifier;
...
class DecodeJob<R>
  ...
  private void runWrapped() throws ClassNotFoundException {
    switch (runReason) {
      case INITIALIZE:
  ...
  private void runGenerators() throws ClassNotFoundException {
  ...
  public void onDataFetcherReady(
      Key sourceKey, Object data, DataFetcher<?> fetcher, DataSource dataSource, Key attemptedKey) throws ClassNotFoundException {
  ...
  private void decodeFromRetrievedData() throws ClassNotFoundException {
  ...
  @Synthetic
  @NonNull
  <Z> Resource<Z> onResourceDecoded(DataSource dataSource, @NonNull Resource<Z> decoded) throws ClassNotFoundException {
    @SuppressWarnings("unchecked")
  ...
  private final class DecodeCallback<Z> implements DecodePath.DecodeCallback<Z> {
    ...
    @NonNull
    @Override
    public Resource<Z> onResourceDecoded(@NonNull Resource<Z> decoded) throws ClassNotFoundException {
