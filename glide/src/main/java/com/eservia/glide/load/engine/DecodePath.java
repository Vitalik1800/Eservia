...
public class DecodePath<DataType, ResourceType, Transcode> {
  ...
  public Resource<Transcode> decode(
      ...
      DecodeCallback<ResourceType> callback)
          throws GlideException, ClassNotFoundException {
  ...
  private Resource<ResourceType> decodeResourceWithList(
    ...
    for (int i = 0, size = decoders.size(); i < size; i++) {
      ...
      } catch (IOException | RuntimeException | OutOfMemoryError | ClassNotFoundException e) {
        e.printStackTrace();
      }
  ...
  interface DecodeCallback<ResourceType> {
    @NonNull
    Resource<ResourceType> onResourceDecoded(@NonNull Resource<ResourceType> resource) throws ClassNotFoundException;
  }
}
