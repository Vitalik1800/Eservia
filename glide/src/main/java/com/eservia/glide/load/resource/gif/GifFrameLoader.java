...
import com.eservia.glide.RequestBuilder;
...
import com.eservia.glide.request.target.CustomTarget;
...
class GifFrameLoader {
  ...
  @Nullable private OnEveryFrameListener onEveryFrameListener;
  ...
  GifFrameLoader(
      ...
      Bitmap firstFrame) throws ClassNotFoundException {
    this(
        glide.getBitmapPool(),
