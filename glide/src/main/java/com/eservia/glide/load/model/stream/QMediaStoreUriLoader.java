...
import com.eservia.glide.load.data.mediastore.MediaStoreUtil;
import com.eservia.glide.load.model.ModelLoader;
import com.eservia.glide.load.model.ModelLoaderFactory;
import com.eservia.glide.load.model.MultiModelLoaderFactory;
...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
  ...
  private static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
    ...
    public void loadData(
        @NonNull Priority priority, @NonNull DataCallback<? super DataT> callback) throws ClassNotFoundException {
      try {
    ...
    @Nullable
    private DataFetcher<DataT> buildDelegateFetcher() throws FileNotFoundException, ClassNotFoundException {
      LoadData<DataT> result = buildDelegateData();
      return result != null ? result.fetcher : null;
    }

    @Nullable
    private LoadData<DataT> buildDelegateData() throws FileNotFoundException, ClassNotFoundException {
