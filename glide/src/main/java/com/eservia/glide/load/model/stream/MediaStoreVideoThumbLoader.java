...
import com.eservia.glide.load.data.mediastore.ThumbFetcher;
...
public class MediaStoreVideoThumbLoader implements ModelLoader<Uri, InputStream> {
  ...
  public LoadData<InputStream> buildLoadData(
      @NonNull Uri model, int width, int height, @NonNull Options options) throws ClassNotFoundException {
