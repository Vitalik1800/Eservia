...
import com.eservia.glide.load.data.HttpUrlFetcher;
import com.eservia.glide.load.model.GlideUrl;
import com.eservia.glide.load.model.ModelCache;
...
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
  ...
  public static final Option<Integer> TIMEOUT =
      Option.memory("com.eservia.glide.load.model.stream.HttpGlideUrlLoader.Timeout", 2500);
