...
class SourceGenerator implements DataFetcherGenerator, DataFetcherGenerator.FetcherReadyCallback {
  ...
  private void startNextLoad(final LoadData<?> toStart) throws ClassNotFoundException {
    loadData.fetcher.loadData(
        helper.getPriority(),
        new DataCallback<Object>() {
          @Override
          public void onDataReady(@Nullable Object data) throws ClassNotFoundException {
  ...
  private boolean hasNextModelLoader() throws ClassNotFoundException {
  ...
  @Synthetic
  void onDataReadyInternal(LoadData<?> loadData, Object data) throws ClassNotFoundException {
  ...
  @SuppressWarnings("WeakerAccess")
  @Synthetic
  void onLoadFailedInternal(LoadData<?> loadData, @NonNull Exception e) throws ClassNotFoundException {
  ...
  public void onDataFetcherFailed(
      Key sourceKey, Exception e, DataFetcher<?> fetcher, DataSource dataSource) throws ClassNotFoundException {
