...
import com.eservia.glide.gifdecoder.GifHeader;
import com.eservia.glide.gifdecoder.GifHeaderParser;
import com.eservia.glide.gifdecoder.StandardGifDecoder;
...
import com.eservia.glide.load.ImageHeaderParserUtils;
...
import com.eservia.glide.load.resource.UnitTransformation;
...
public class ByteBufferGifDecoder implements ResourceDecoder<ByteBuffer, GifDrawable> {
  ...
  public GifDrawableResource decode(
      @NonNull ByteBuffer source, int width, int height, @NonNull Options options) throws ClassNotFoundException {
  ...
  private GifDrawableResource decode(
      ByteBuffer byteBuffer, int width, int height, GifHeaderParser parser, Options options) throws ClassNotFoundException {
