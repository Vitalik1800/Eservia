...
import com.eservia.glide.load.ImageHeaderParser.ImageType;
import com.eservia.glide.load.Option;
import com.eservia.glide.load.Options;
import com.eservia.glide.load.PreferredColorSpace;
...
import com.eservia.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT =
      Option.memory(
          "com.eservia.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  ...
  public static final Option<PreferredColorSpace> PREFERRED_COLOR_SPACE =
      Option.memory("com.eservia.glide.load.resource.bitmap.Downsampler.PreferredColorSpace");
  @Deprecated
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.eservia.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);

  public static final Option<Boolean> ALLOW_HARDWARE_CONFIG =
      Option.memory(
          "com.eservia.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", false);
