...
import com.eservia.model.remote.rest.business_beauty.services.promotion.PromotionService
import com.eservia.model.remote.rest.business_beauty.services.service.ServiceService
import com.eservia.model.remote.rest.business_beauty.services.service_group.ServiceGroupService
import com.eservia.model.remote.rest.business_beauty.services.staff.StaffService
import com.eservia.model.remote.rest.business_beauty.services.working_day.WorkingDayService
...
class BusinessBeautyServer(private val url: String, private val okHttpClient: OkHttpClient) {
    ...
    fun providePromotionService(): Observable<PromotionService> {
        return provideService(PromotionService::class.java)
    }
