...
public class BusinessComment implements Validator {
    ...
    private UserInfoShort userInfo;
    ...
    public UserInfoShort getUserInfo() {
        return userInfo;
    }

    public void setUserInfo(UserInfoShort userInfo) {
