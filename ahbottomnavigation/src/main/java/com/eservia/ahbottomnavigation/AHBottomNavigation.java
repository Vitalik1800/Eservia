...
import com.eservia.ahbottomnavigation.notification.AHNotification;
import com.eservia.ahbottomnavigation.notification.AHNotificationHelper;
...
public class AHBottomNavigation extends FrameLayout {
	...
	// Static
	private static final String TAG = "AHBottomNavigation";
	...
	private final ArrayList<AHBottomNavigationItem> items = new ArrayList<>();
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			@SuppressLint("CustomViewStyleable") TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.AHBottomNavigationBehavior_Params, 0, 0);
			try {
	...
	private int calculateHeight(int layoutHeight) {
		...
		@SuppressLint("ResourceType") TypedArray typedValue = getContext().getTheme().obtainStyledAttributes(attrs);
